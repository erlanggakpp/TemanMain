                    ...
                    <Col md={{ span: 7, offset: 3 }}>
                        <div classname="container-sm mt-5">
                            ...
                            <Form.Group className="mb-1" controlId="exampleForm.ControlTextarea1">
                                ...
                                <Form.Control as="textarea" rows={3} placeholder="Description this Event" />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
                            ...
                            <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
                                ...
                                <Form.Control type="text" placeholder="Event Homepage Link" />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
                                <Form.Label>Event Duration</Form.Label>
                                <Form.Control type="text" placeholder="Event Duration in Day" />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
                                <Form.Label>Image</Form.Label>
                                <Form.Control type="text" placeholder="Image That Event" />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
