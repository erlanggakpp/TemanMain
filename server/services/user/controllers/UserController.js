...
class UserController {
    ...
    static async createUser(req, res, next) {
        try {
            const { email, password, firstName, lastName, address, birthdate, profilePict, instagramAccount, twitterAccount, phoneNumber, gender, role } = req.body
            
            const newUser = await User.create({ email, password, firstName, lastName, address, birthdate, profilePict, instagramAccount, twitterAccount, phoneNumber, gender, role })
    ...
    static async updateUser(req, res, next) {
        try {
            const { id } = req.params
            let { email, password, firstName, lastName, address, birthdate, profilePict, instagramAccount, twitterAccount, phoneNumber, gender, role } = req.body
            ...
            await User.update(
                { email, password, firstName, lastName, address, birthdate, profilePict, instagramAccount, twitterAccount, phoneNumber, gender, role },
    ...
    static async register(req, res, next) {
        try {
            const { email, password, firstName, lastName, address, birthdate, profilePict, instagramAccount, twitterAccount, phoneNumber, gender } = req.body
