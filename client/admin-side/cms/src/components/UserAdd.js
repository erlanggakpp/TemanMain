                    ...
                    <Col md={{ span: 7, offset: 3 }}>
                        ...
                        <div classname="container-sm mt-5">
                            ...
                            <Form.Group className="mb-1" controlId="profilePict">
                                ...
                                <Form.Control name="profilePict" type="text" placeholder="Url Image" onChange={changeInputUser} />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="instagramAccount">
                                <Form.Label>Instagram Account</Form.Label>
                                <Form.Control name="instagramAccount" type="text" placeholder="Instgram Url" onChange={changeInputUser} />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="twitterAccount">
                                <Form.Label>Twitter Account</Form.Label>
                                <Form.Control name="twitterAccount" type="text" placeholder="Twitter Url" onChange={changeInputUser} />
                            </Form.Group>
                            <Form.Group className="mb-1" controlId="phoneNumber">
                                <Form.Label>Phone Number</Form.Label>
                                <Form.Control name="phoneNumber" type="text" placeholder="Url Image" onChange={changeInputUser} />
                            </Form.Group>
                            <Form.Label>Gender</Form.Label>
                            <Form.Select name="gender" className="mb-1" aria-label="Default select example" onChange={changeInputUser}>
