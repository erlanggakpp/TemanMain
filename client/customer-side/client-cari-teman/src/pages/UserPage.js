          ...
          >
            <div className="row">
              ...
              <div className="col-md-8 d-flex justify-content-center align-items-end">
                <div>
                  <h1>ERLANGGA KENCANA</h1>
                  <p>jalan menuju teacher, abis itu gas valorant</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row g-5">
              <div className="col-md-8">
                ...
                <p className="p-4">
                  ...
                  similique sint at sunt minima accusantium explicabo.
                </p>
                <br />
                <br />
              </div>
                ...
                <div className="position-sticky" style={{ top: "2rem" }}>
                  ...
                  <div className="p-4">
                    ...
                    <p>
                      ...
                      Quis eum reiciendis sequi quibusdam suscipit quo rem a.
                      Sequi ipsum temporibus soluta minima error doloremque
                      ullam rerum optio quis, sunt est.
                    </p>
                  </div>
                </div>
              </div>
